...
In this case is {\em data} field the element that contains the data of the image, so we are going to encrypt this element before to be publisher in ROS distributed system.





We use the 3DES algorithm that provides a security layer to protect data.
