...
Figure~\ref{fig:TestBed} provides a graphical representation of the scenario we wanted to simulate. In this case, two clients are connected to a topic. This situation is transparent to ROS Master.
